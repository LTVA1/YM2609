...
class fmgen
{
    ...
    public:
        ...
        class Operator
        {
            public:
                ...
                Operator()
                {
                    ...
                    decaytable1 = new int8_t*[64]
                    {
                    new int8_t[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, new int8_t[8]{ 0, 0, 0, 0, 0, 0, 0, 0 },
                    new int8_t[8]{1, 1, 1, 1, 1, 1, 1, 1 },new int8_t[8]{     1, 1, 1, 1, 1, 1, 1, 1},
                    new int8_t[8]{1, 1, 1, 1, 1, 1, 1, 1 },new int8_t[8]{     1, 1, 1, 1, 1, 1, 1, 1},
                    new int8_t[8]{1, 1, 1, 0, 1, 1, 1, 0 },new int8_t[8]{     1, 1, 1, 0, 1, 1, 1, 0},
                    new int8_t[8]{1, 0, 1, 0, 1, 0, 1, 0 },new int8_t[8]{     1, 1, 1, 0, 1, 0, 1, 0},
                    new int8_t[8]{1, 1, 1, 0, 1, 1, 1, 0 },new int8_t[8]{     1, 1, 1, 1, 1, 1, 1, 0},
                    new int8_t[8]{1, 0, 1, 0, 1, 0, 1, 0 },new int8_t[8]{     1, 1, 1, 0, 1, 0, 1, 0},
                    new int8_t[8]{1, 1, 1, 0, 1, 1, 1, 0 },new int8_t[8]{     1, 1, 1, 1, 1, 1, 1, 0},
                    new int8_t[8]{1, 0, 1, 0, 1, 0, 1, 0 },new int8_t[8]{     1, 1, 1, 0, 1, 0, 1, 0},
                    new int8_t[8]{1, 1, 1, 0, 1, 1, 1, 0 },new int8_t[8]{     1, 1, 1, 1, 1, 1, 1, 0},
                    ...
                    new int8_t[8]{1, 0, 1, 0, 1, 0, 1, 0 },new int8_t[8]{     1, 1, 1, 0, 1, 0, 1, 0},
                    new int8_t[8]{1, 1, 1, 0, 1, 1, 1, 0 },new int8_t[8]{     1, 1, 1, 1, 1, 1, 1, 0},
                    new int8_t[8]{1, 1, 1, 1, 1, 1, 1, 1 },new int8_t[8]{     2, 1, 1, 1, 2, 1, 1, 1},
                    new int8_t[8]{2, 1, 2, 1, 2, 1, 2, 1 },new int8_t[8]{     2, 2, 2, 1, 2, 2, 2, 1},
                    new int8_t[8]{2, 2, 2, 2, 2, 2, 2, 2 },new int8_t[8]{     4, 2, 2, 2, 4, 2, 2, 2},
                    new int8_t[8]{4, 2, 4, 2, 4, 2, 4, 2 },new int8_t[8]{     4, 4, 4, 2, 4, 4, 4, 2},
                    new int8_t[8]{4, 4, 4, 4, 4, 4, 4, 4 },new int8_t[8]{     8, 4, 4, 4, 8, 4, 4, 4},
                    new int8_t[8]{8, 4, 8, 4, 8, 4, 8, 4 },new int8_t[8]{     8, 8, 8, 4, 8, 8, 8, 4},
                    new int8_t[8]{16,16,16,16,16,16,16,16 },new int8_t[8]{    16,16,16,16,16,16,16,16},
                    new int8_t[8]{16,16,16,16,16,16,16,16 },new int8_t[8]{    16,16,16,16,16,16,16,16}
                    };

                    decaytable2 = new int[16]
                    {
                        1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2047, 2047, 2047, 2047, 2047
                    };

                    attacktable = new int8_t*[64]
                    {
                    new int8_t[8]{  -1,-1,-1,-1,-1,-1,-1,-1},new int8_t[8]{ -1,-1,-1,-1,-1,-1,-1,-1},
                    new int8_t[8]{   4, 4, 4, 4, 4, 4, 4, 4},new int8_t[8]{  4, 4, 4, 4, 4, 4, 4, 4},
                    new int8_t[8]{   4, 4, 4, 4, 4, 4, 4, 4},new int8_t[8]{  4, 4, 4, 4, 4, 4, 4, 4},
                    new int8_t[8]{   4, 4, 4,-1, 4, 4, 4,-1},new int8_t[8]{  4, 4, 4,-1, 4, 4, 4,-1},
                    new int8_t[8]{   4,-1, 4,-1, 4,-1, 4,-1},new int8_t[8]{  4, 4, 4,-1, 4,-1, 4,-1},
                    new int8_t[8]{   4, 4, 4,-1, 4, 4, 4,-1},new int8_t[8]{  4, 4, 4, 4, 4, 4, 4,-1},
                    new int8_t[8]{   4,-1, 4,-1, 4,-1, 4,-1},new int8_t[8]{  4, 4, 4,-1, 4,-1, 4,-1},
                    new int8_t[8]{   4, 4, 4,-1, 4, 4, 4,-1},new int8_t[8]{  4, 4, 4, 4, 4, 4, 4,-1},
                    new int8_t[8]{   4,-1, 4,-1, 4,-1, 4,-1},new int8_t[8]{  4, 4, 4,-1, 4,-1, 4,-1},
                    new int8_t[8]{   4, 4, 4,-1, 4, 4, 4,-1},new int8_t[8]{  4, 4, 4, 4, 4, 4, 4,-1},
                    ...
                    new int8_t[8]{   4,-1, 4,-1, 4,-1, 4,-1},new int8_t[8]{  4, 4, 4,-1, 4,-1, 4,-1},
                    new int8_t[8]{   4, 4, 4,-1, 4, 4, 4,-1},new int8_t[8]{  4, 4, 4, 4, 4, 4, 4,-1},
                    new int8_t[8]{   4, 4, 4, 4, 4, 4, 4, 4},new int8_t[8]{  3, 4, 4, 4, 3, 4, 4, 4},
                    new int8_t[8]{   3, 4, 3, 4, 3, 4, 3, 4},new int8_t[8]{  3, 3, 3, 4, 3, 3, 3, 4},
                    new int8_t[8]{   3, 3, 3, 3, 3, 3, 3, 3},new int8_t[8]{  2, 3, 3, 3, 2, 3, 3, 3},
                    new int8_t[8]{   2, 3, 2, 3, 2, 3, 2, 3},new int8_t[8]{  2, 2, 2, 3, 2, 2, 2, 3},
                    new int8_t[8]{   2, 2, 2, 2, 2, 2, 2, 2},new int8_t[8]{  1, 2, 2, 2, 1, 2, 2, 2},
                    new int8_t[8]{   1, 2, 1, 2, 1, 2, 1, 2},new int8_t[8]{  1, 1, 1, 2, 1, 1, 1, 2},
                    new int8_t[8]{   0, 0, 0, 0, 0, 0, 0, 0},new int8_t[8]{  0, 0 ,0, 0, 0, 0, 0, 0},
                    new int8_t[8]{   0, 0, 0, 0, 0, 0, 0, 0},new int8_t[8]{  0, 0 ,0, 0, 0, 0, 0, 0}
                    };

                    ssgenvtable = new int***[8] {
                        new int**[2] {
        ...
        class Channel4
        {
            ...
            //
            private:
                static uint8_t* fbtable;
                static bool tablehasmade;
                static int* kftable;
                uint32_t fb;
                int* buf;
                int* In;          // 各 OP の入力ポインタ
                int* Out;         // 各 OP の出力ポインタ
                int* pms;
                int algo_;
                Chip chip_;
            ...
            public:
                ...
                Channel4()
                {
                    ...
                    fbtable = new uint8_t[8] { 31, 7, 6, 5, 4, 3, 2, 1 };
